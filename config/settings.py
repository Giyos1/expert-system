...
SECRET_KEY = 'django-insecure-1@4xt41zlp!)!@lu2oh8bv%&o%h_xgr$tcfbd-8h^otl@)=@n&'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [path_join(BASE_DIR, 'shop/static')]
# STATIC_ROOT = path_join(BASE_DIR, 'staticfiles')
